  ...
  return (
    <div className="control-shell">
      ...
      <main className="control-main">
        <header className="control-topbar"><a href="/estrutura" className="back-to-atlas"><ArrowLeft size={16} /> Estrutura interna</a><div className="control-topbar-actions"><a href="/controle/fila-editorial" className="control-link">Fila editorial rápida</a><a href="/compendio" className="control-link">Compêndio jurídico</a></div></header>
