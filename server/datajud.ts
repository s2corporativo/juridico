const DATAJUD_BASE_URL=process.env.DATAJUD_BASE_URL?.trim().replace(/\/$/,"")||"https://api-publica.datajud.cnj.jus.br";const DATAJUD_ACCESS_URL="https://datajud-wiki.cnj.jus.br/api-publica/acesso/";export const DATAJUD_ALIASES=["tjmg","trt3","trf6","tre-mg","tjmmg"] as const;export const NATIONAL_DATAJUD_ALIASES=["tjac","tjal","tjam","tjap","tjba","tjce","tjdft","tjes","tjgo","tjma","tjmg","tjms","tjmt","tjpa","tjpb","tjpe","tjpi","tjpr","tjrj","tjrn","tjro","tjrr","tjrs","tjsc","tjse","tjsp","tjto"] as const;export type DataJudAlias=(typeof DATAJUD_ALIASES)[number];export type NationalDataJudAlias=(typeof NATIONAL_DATAJUD_ALIASES)[number];
